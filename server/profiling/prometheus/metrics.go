...
func (m *Metrics) SetChannelTotal(hostname string, projectID types.ID, projectName string, count int) {
...
func (m *Metrics) SetChannelSessionsTotal(hostname string, projectID types.ID, projectName string, count int) {
