...
var errorToCode = map[error]string{
	converter.ErrPackRequired:       "converter.ErrPackRequired",
	converter.ErrCheckpointRequired: "converter.ErrCheckpointRequired",
	time.ErrInvalidHexString:        "time.ErrInvalidHexString",
	time.ErrInvalidActorID:          "time.ErrInvalidActorID",
	types.ErrInvalidID:              "types.ErrInvalidID",
	clients.ErrInvalidClientID:      "clients.ErrInvalidClientID",
	clients.ErrInvalidClientKey:     "clients.ErrInvalidClientKey",
	key.ErrInvalidKey:               "key.ErrInvalidKey",
	types.ErrEmptyProjectFields:     "types.ErrEmptyProjectFields",

	database.ErrProjectNotFound:  "database.ErrProjectNotFound",
	database.ErrClientNotFound:   "database.ErrClientNotFound",
	database.ErrDocumentNotFound: "database.ErrDocumentNotFound",
	database.ErrUserNotFound:     "database.ErrUserNotFound",

	database.ErrProjectAlreadyExists:     "database.ErrProjectAlreadyExists",
	database.ErrProjectNameAlreadyExists: "database.ErrProjectNameAlreadyExists",
	database.ErrUserAlreadyExists:        "database.ErrUserAlreadyExists",

	database.ErrClientNotActivated:      "database.ErrClientNotActivated",
	database.ErrDocumentNotAttached:     "database.ErrDocumentNotAttached",
	database.ErrDocumentAlreadyAttached: "database.ErrDocumentAlreadyAttached",
	database.ErrDocumentAlreadyDetached: "database.ErrDocumentAlreadyDetached",
	documents.ErrDocumentAttached:       "documents.ErrDocumentAttached",
	packs.ErrInvalidServerSeq:           "packs.ErrInvalidServerSeq",
	database.ErrConflictOnUpdate:        "database.ErrConflictOnUpdate",

	converter.ErrUnsupportedOperation:   "converter.ErrUnsupportedOperation",
	converter.ErrUnsupportedElement:     "converter.ErrUnsupportedElement",
	converter.ErrUnsupportedEventType:   "converter.ErrUnsupportedEventType",
	converter.ErrUnsupportedValueType:   "converter.ErrUnsupportedValueType",
	converter.ErrUnsupportedCounterType: "converter.ErrUnsupportedCounterType",

	auth.ErrNotAllowed:             "auth.ErrNotAllowed",
	auth.ErrUnexpectedStatusCode:   "auth.ErrUnexpectedStatusCode",
	auth.ErrWebhookTimeout:         "auth.ErrWebhookTimeout",
	database.ErrMismatchedPassword: "database.ErrMismatchedPassword",
}
