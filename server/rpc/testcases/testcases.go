...
func RunActivateAndDeactivateClientTest(
	...
	_, err = testClient.DeactivateClient(
		context.Background(),
		connect.NewRequest(&api.DeactivateClientRequest{ClientId: emptyClientID, ClientKey: clientKey}))
	assert.Equal(t, connect.CodeInvalidArgument, connect.CodeOf(err))
	...
	_, err = testClient.DeactivateClient(
		context.Background(),
		connect.NewRequest(&api.DeactivateClientRequest{ClientId: nilClientID, ClientKey: clientKey}))
