...
func (s *systemServer) ActivateClient(
	ctx context.Context,
...
func (s *systemServer) DeactivateClient(
	ctx context.Context,
...
func (s *systemServer) AttachDocument(
	ctx context.Context,
...
func (s *systemServer) PushPullChanges(
	ctx context.Context,
...
func (s *systemServer) WatchDocument(
	ctx context.Context,
...
func (s *systemServer) RemoveDocument(
	ctx context.Context,
...
func (s *systemServer) unwatchDoc(
