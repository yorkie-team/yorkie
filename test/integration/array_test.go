...
func TestArray(t *testing.T) {
	...
	t.Run("array remove undo test", func(t *testing.T) {
		...
		// Redo replays Add's own reverse (a Remove of the just-restored
		// element), proving that the reverse generated by Add.Execute
		// composes correctly with the reissue this Undo just exercised.
...
func TestArrayConcurrency(t *testing.T) {
	...
	ctx := context.Background()
	d0 := document.New(helper.TestKey(t))
