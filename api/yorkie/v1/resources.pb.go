...
type UpdatableProjectFields struct {
	...
	StreamCountLimitPerDocument *wrapperspb.Int32Value                     `protobuf:"bytes,7,opt,name=stream_count_limit_per_document,json=streamCountLimitPerDocument,proto3" json:"stream_count_limit_per_document,omitempty"`
}
