...
const (
	BoundaryType_BOUNDARY_TYPE_BEFORE BoundaryType = 0
	BoundaryType_BOUNDARY_TYPE_AFTER  BoundaryType = 1
	BoundaryType_BOUNDARY_TYPE_START  BoundaryType = 2
	BoundaryType_BOUNDARY_TYPE_END    BoundaryType = 3
	BoundaryType_BOUNDARY_TYPE_NONE   BoundaryType = 4
)

var BoundaryType_name = map[int32]string{
	0: "BOUNDARY_TYPE_BEFORE",
	1: "BOUNDARY_TYPE_AFTER",
	2: "BOUNDARY_TYPE_START",
	3: "BOUNDARY_TYPE_END",
	4: "BOUNDARY_TYPE_NONE",
}
...
func (PresenceChange_ChangeType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_36361b2f5d0f0896, []int{22, 0}
}
...
type Operation_Style struct {
	ParentCreatedAt      *TimeTicket            `protobuf:"bytes,1,opt,name=parent_created_at,json=parentCreatedAt,proto3" json:"parent_created_at,omitempty"`
	From                 *TextNodeBoundary      `protobuf:"bytes,2,opt,name=from,proto3" json:"from,omitempty"`
	To                   *TextNodeBoundary      `protobuf:"bytes,3,opt,name=to,proto3" json:"to,omitempty"`
...
func (m *Operation_Style) GetFrom() *TextNodeBoundary {
	if m != nil {
		return m.From
	}
	return nil
...
func (m *Operation_Style) GetTo() *TextNodeBoundary {
	if m != nil {
		return m.To
	}
	return nil
...
type TextNode struct {
	...
	MarkOpsBefore        *MarkOps             `protobuf:"bytes,6,opt,name=mark_ops_before,json=markOpsBefore,proto3" json:"mark_ops_before,omitempty"`
	MarkOpsAfter         *MarkOps             `protobuf:"bytes,7,opt,name=mark_ops_after,json=markOpsAfter,proto3" json:"mark_ops_after,omitempty"`
	XXX_NoUnkeyedLiteral struct{}             `json:"-"`
	XXX_unrecognized     []byte               `json:"-"`
	XXX_sizecache        int32                `json:"-"`
}
...
func (m *TextNode) GetMarkOpsBefore() *MarkOps {
	if m != nil {
		return m.MarkOpsBefore
	}
	return nil
}

func (m *TextNode) GetMarkOpsAfter() *MarkOps {
	if m != nil {
		return m.MarkOpsAfter
	}
	return nil
}
...
type MarkOps struct {
	Operations           []*MarkOp `protobuf:"bytes,1,rep,name=operations,proto3" json:"operations,omitempty"`
	XXX_NoUnkeyedLiteral struct{}  `json:"-"`
	XXX_unrecognized     []byte    `json:"-"`
	XXX_sizecache        int32     `json:"-"`
}

func (m *MarkOps) Reset()         { *m = MarkOps{} }
func (m *MarkOps) String() string { return proto.CompactTextString(m) }
func (*MarkOps) ProtoMessage()    {}
func (*MarkOps) Descriptor() ([]byte, []int) {
	return fileDescriptor_36361b2f5d0f0896, []int{12}
}
func (m *MarkOps) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MarkOps) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MarkOps.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MarkOps) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MarkOps.Merge(m, src)
}
func (m *MarkOps) XXX_Size() int {
	return m.Size()
}
func (m *MarkOps) XXX_DiscardUnknown() {
	xxx_messageInfo_MarkOps.DiscardUnknown(m)
}

var xxx_messageInfo_MarkOps proto.InternalMessageInfo

func (m *MarkOps) GetOperations() []*MarkOp {
	if m != nil {
		return m.Operations
	}
	return nil
...
type MarkOp struct {
	FromBoundary         *TextNodeBoundary `protobuf:"bytes,1,opt,name=from_boundary,json=fromBoundary,proto3" json:"from_boundary,omitempty"`
	ToBoundary           *TextNodeBoundary `protobuf:"bytes,2,opt,name=to_boundary,json=toBoundary,proto3" json:"to_boundary,omitempty"`
...
func (m *MarkOp) Reset()         { *m = MarkOp{} }
func (m *MarkOp) String() string { return proto.CompactTextString(m) }
func (*MarkOp) ProtoMessage()    {}
func (*MarkOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_36361b2f5d0f0896, []int{13}
}
func (m *MarkOp) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MarkOp) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_MarkOp.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *MarkOp) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MarkOp.Merge(m, src)
}
func (m *MarkOp) XXX_Size() int {
	return m.Size()
}
func (m *MarkOp) XXX_DiscardUnknown() {
	xxx_messageInfo_MarkOp.DiscardUnknown(m)
}

var xxx_messageInfo_MarkOp proto.InternalMessageInfo

func (m *MarkOp) GetFromBoundary() *TextNodeBoundary {
	if m != nil {
		return m.FromBoundary
	}
	return nil
}

func (m *MarkOp) GetToBoundary() *TextNodeBoundary {
	if m != nil {
		return m.ToBoundary
	}
	return nil
...
func (m *MarkOp) GetAttributes() map[string]string {
	if m != nil {
		return m.Attributes
	}
	return nil
...
type TextNodeBoundary struct {
	CreatedAt            *TimeTicket  `protobuf:"bytes,1,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"`
	Offset               int32        `protobuf:"varint,2,opt,name=offset,proto3" json:"offset,omitempty"`
	Type                 BoundaryType `protobuf:"varint,3,opt,name=type,proto3,enum=yorkie.v1.BoundaryType" json:"type,omitempty"`
	XXX_NoUnkeyedLiteral struct{}     `json:"-"`
	XXX_unrecognized     []byte       `json:"-"`
	XXX_sizecache        int32        `json:"-"`
}

func (m *TextNodeBoundary) Reset()         { *m = TextNodeBoundary{} }
func (m *TextNodeBoundary) String() string { return proto.CompactTextString(m) }
func (*TextNodeBoundary) ProtoMessage()    {}
func (*TextNodeBoundary) Descriptor() ([]byte, []int) {
	return fileDescriptor_36361b2f5d0f0896, []int{26}
}
func (m *TextNodeBoundary) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TextNodeBoundary) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TextNodeBoundary.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TextNodeBoundary) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TextNodeBoundary.Merge(m, src)
}
func (m *TextNodeBoundary) XXX_Size() int {
	return m.Size()
}
func (m *TextNodeBoundary) XXX_DiscardUnknown() {
	xxx_messageInfo_TextNodeBoundary.DiscardUnknown(m)
}

var xxx_messageInfo_TextNodeBoundary proto.InternalMessageInfo

func (m *TextNodeBoundary) GetCreatedAt() *TimeTicket {
	if m != nil {
		return m.CreatedAt
	}
	return nil
...
func (m *TextNodeBoundary) GetOffset() int32 {
	if m != nil {
		return m.Offset
	}
	return 0
...
func (m *TextNodeBoundary) GetType() BoundaryType {
	if m != nil {
		return m.Type
	}
	return BoundaryType_BOUNDARY_TYPE_BEFORE
}
...
func (*TimeTicket) Descriptor() ([]byte, []int) {
	return fileDescriptor_36361b2f5d0f0896, []int{27}
}
...
func (*DocEvent) Descriptor() ([]byte, []int) {
	return fileDescriptor_36361b2f5d0f0896, []int{28}
}
...
func init() {
	proto.RegisterEnum("yorkie.v1.BoundaryType", BoundaryType_name, BoundaryType_value)
	...
	proto.RegisterType((*MarkOps)(nil), "yorkie.v1.MarkOps")
	proto.RegisterType((*MarkOp)(nil), "yorkie.v1.MarkOp")
	proto.RegisterMapType((map[string]string)(nil), "yorkie.v1.MarkOp.AttributesEntry")
	...
	proto.RegisterType((*TextNodeBoundary)(nil), "yorkie.v1.TextNodeBoundary")
...
var fileDescriptor_36361b2f5d0f0896 = []byte{
	...
	,
}
...
func (m *TextNode) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.MarkOpsAfter != nil {
		{
			size, err := m.MarkOpsAfter.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.MarkOpsBefore != nil {
		{
			size, err := m.MarkOpsBefore.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *MarkOps) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MarkOps) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MarkOps) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *MarkOp) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MarkOp) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MarkOp) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.ToBoundary != nil {
		{
			size, err := m.ToBoundary.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.FromBoundary != nil {
		{
			size, err := m.FromBoundary.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *TextNodeBoundary) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TextNodeBoundary) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TextNodeBoundary) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *TextNode) Size() (n int) {
	...
	if m.MarkOpsBefore != nil {
		l = m.MarkOpsBefore.Size()
		n += 1 + l + sovResources(uint64(l))
	}
	if m.MarkOpsAfter != nil {
		l = m.MarkOpsAfter.Size()
		n += 1 + l + sovResources(uint64(l))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
...
func (m *TextNodeBoundary) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TextNode) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MarkOpsBefore", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.MarkOpsBefore == nil {
				m.MarkOpsBefore = &MarkOps{}
			}
			if err := m.MarkOpsBefore.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field MarkOpsAfter", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.MarkOpsAfter == nil {
				m.MarkOpsAfter = &MarkOps{}
			}
			if err := m.MarkOpsAfter.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *MarkOps) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MarkOps: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MarkOps: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Operations = append(m.Operations, &MarkOp{})
			if err := m.Operations[len(m.Operations)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
...
func (m *MarkOp) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MarkOp: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MarkOp: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field FromBoundary", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.FromBoundary == nil {
				m.FromBoundary = &TextNodeBoundary{}
			}
			if err := m.FromBoundary.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ToBoundary", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.ToBoundary == nil {
				m.ToBoundary = &TextNodeBoundary{}
			}
			if err := m.ToBoundary.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
...
func (m *TextNodeBoundary) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TextNodeBoundary: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TextNodeBoundary: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= BoundaryType(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
