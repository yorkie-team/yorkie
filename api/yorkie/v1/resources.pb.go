...
func (PresenceChange_ChangeType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_36361b2f5d0f0896, []int{21, 0}
}
...
type Operation_EditReverse_ struct {
	EditReverse *Operation_EditReverse `protobuf:"bytes,11,opt,name=edit_reverse,json=editReverse,proto3,oneof" json:"edit_reverse,omitempty"`
}
...
func (*Operation_EditReverse_) isOperation_Body() {}
...
func (m *Operation) GetEditReverse() *Operation_EditReverse {
	if x, ok := m.GetBody().(*Operation_EditReverse_); ok {
		return x.EditReverse
	}
	return nil
}
...
type Operation_EditReverse struct {
	ParentCreatedAt      *TimeTicket             `protobuf:"bytes,1,opt,name=parent_created_at,json=parentCreatedAt,proto3" json:"parent_created_at,omitempty"`
	DeletedIds           []*TextNodeIDWithLength `protobuf:"bytes,2,rep,name=deleted_ids,json=deletedIds,proto3" json:"deleted_ids,omitempty"`
	InsertedIds          []*TextNodeIDWithLength `protobuf:"bytes,3,rep,name=inserted_ids,json=insertedIds,proto3" json:"inserted_ids,omitempty"`
	CreatedAtMapByActor  map[string]*TimeTicket  `protobuf:"bytes,4,rep,name=created_at_map_by_actor,json=createdAtMapByActor,proto3" json:"created_at_map_by_actor,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	ExecutedAt           *TimeTicket             `protobuf:"bytes,5,opt,name=executed_at,json=executedAt,proto3" json:"executed_at,omitempty"`
...
func (m *Operation_EditReverse) Reset()         { *m = Operation_EditReverse{} }
func (m *Operation_EditReverse) String() string { return proto.CompactTextString(m) }
func (*Operation_EditReverse) ProtoMessage()    {}
func (*Operation_EditReverse) Descriptor() ([]byte, []int) {
	return fileDescriptor_36361b2f5d0f0896, []int{4, 10}
}
func (m *Operation_EditReverse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *Operation_EditReverse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_Operation_EditReverse.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *Operation_EditReverse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Operation_EditReverse.Merge(m, src)
}
func (m *Operation_EditReverse) XXX_Size() int {
	return m.Size()
}
func (m *Operation_EditReverse) XXX_DiscardUnknown() {
	xxx_messageInfo_Operation_EditReverse.DiscardUnknown(m)
}

var xxx_messageInfo_Operation_EditReverse proto.InternalMessageInfo

func (m *Operation_EditReverse) GetParentCreatedAt() *TimeTicket {
	if m != nil {
		return m.ParentCreatedAt
	}
	return nil
...
func (m *Operation_EditReverse) GetDeletedIds() []*TextNodeIDWithLength {
	if m != nil {
		return m.DeletedIds
	}
	return nil
...
func (m *Operation_EditReverse) GetInsertedIds() []*TextNodeIDWithLength {
	if m != nil {
...
func (m *Operation_EditReverse) GetCreatedAtMapByActor() map[string]*TimeTicket {
	if m != nil {
		return m.CreatedAtMapByActor
	}
	return nil
...
func (m *Operation_EditReverse) GetExecutedAt() *TimeTicket {
	if m != nil {
		return m.ExecutedAt
	}
	return nil
...
func (m *Operation_EditReverse) GetAttributes() map[string]string {
	if m != nil {
		return m.Attributes
	}
	return nil
...
type TextNodeIDWithLength struct {
	NodeId               *TextNodeID `protobuf:"bytes,1,opt,name=node_id,json=nodeId,proto3" json:"node_id,omitempty"`
...
func (m *TextNodeIDWithLength) Reset()         { *m = TextNodeIDWithLength{} }
func (m *TextNodeIDWithLength) String() string { return proto.CompactTextString(m) }
func (*TextNodeIDWithLength) ProtoMessage()    {}
func (*TextNodeIDWithLength) Descriptor() ([]byte, []int) {
	return fileDescriptor_36361b2f5d0f0896, []int{12}
}
func (m *TextNodeIDWithLength) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TextNodeIDWithLength) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_TextNodeIDWithLength.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *TextNodeIDWithLength) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TextNodeIDWithLength.Merge(m, src)
}
func (m *TextNodeIDWithLength) XXX_Size() int {
	return m.Size()
}
func (m *TextNodeIDWithLength) XXX_DiscardUnknown() {
	xxx_messageInfo_TextNodeIDWithLength.DiscardUnknown(m)
}

var xxx_messageInfo_TextNodeIDWithLength proto.InternalMessageInfo

func (m *TextNodeIDWithLength) GetNodeId() *TextNodeID {
	if m != nil {
		return m.NodeId
	}
	return nil
...
func (m *TextNodeIDWithLength) GetLength() int32 {
	if m != nil {
		return m.Length
	}
	return 0
...
func (*UpdatableProjectFields_AuthWebhookMethods) Descriptor() ([]byte, []int) {
	return fileDescriptor_36361b2f5d0f0896, []int{19, 0}
}
...
func init() {
	...
	proto.RegisterType((*Operation_EditReverse)(nil), "yorkie.v1.Operation.EditReverse")
	proto.RegisterMapType((map[string]string)(nil), "yorkie.v1.Operation.EditReverse.AttributesEntry")
	proto.RegisterMapType((map[string]*TimeTicket)(nil), "yorkie.v1.Operation.EditReverse.CreatedAtMapByActorEntry")
	...
	proto.RegisterType((*TextNodeIDWithLength)(nil), "yorkie.v1.TextNodeIDWithLength")
...
var fileDescriptor_36361b2f5d0f0896 = []byte{
	...
	,
}
...
func (m *Operation_EditReverse_) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Operation_EditReverse_) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	if m.EditReverse != nil {
		{
			size, err := m.EditReverse.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *Operation_EditReverse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *Operation_EditReverse) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *Operation_EditReverse) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if len(m.InsertedIds) > 0 {
		for iNdEx := len(m.InsertedIds) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.InsertedIds[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.DeletedIds) > 0 {
		for iNdEx := len(m.DeletedIds) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.DeletedIds[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
...
func (m *TextNodeIDWithLength) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *TextNodeIDWithLength) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *TextNodeIDWithLength) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	...
	if m.Length != 0 {
		i = encodeVarintResources(dAtA, i, uint64(m.Length))
		i--
		dAtA[i] = 0x10
	}
	if m.NodeId != nil {
...
func (m *Operation_EditReverse_) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *Operation_EditReverse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *TextNodeIDWithLength) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.Length != 0 {
		n += 1 + sovResources(uint64(m.Length))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
...
func (m *Operation) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 11:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EditReverse", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			v := &Operation_EditReverse{}
			if err := v.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			m.Body = &Operation_EditReverse_{v}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipResources(dAtA[iNdEx:])
...
func (m *Operation_EditReverse) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EditReverse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EditReverse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 2:
			...
			m.DeletedIds = append(m.DeletedIds, &TextNodeIDWithLength{})
			if err := m.DeletedIds[len(m.DeletedIds)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 3:
			...
			m.InsertedIds = append(m.InsertedIds, &TextNodeIDWithLength{})
			if err := m.InsertedIds[len(m.InsertedIds)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
...
func (m *TextNodeIDWithLength) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TextNodeIDWithLength: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TextNodeIDWithLength: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
