...
const (
	...
	// DetachDocument RPC.
	SystemServiceDetachDocumentProcedure = "/system.v1.SystemService/DetachDocument"
)
...
// DetachDocument calls system.v1.SystemService.DetachDocument.
...
func (UnimplementedSystemServiceHandler) DetachDocument(context.Context, *connect.Request[v1.DetachDocumentRequest]) (*connect.Response[v1.DetachDocumentResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("system.v1.SystemService.DetachDocument is not implemented"))
}
