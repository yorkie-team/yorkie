...
// a split product — but the wire format carries InsPrevID/InsNextID anyway and
// the tree follows them as trusted structural pointers, up to and including a
// chain that loops back on itself. Drop them on the way in, as
// FromTreeNodesWhenEdit does for operation content.
