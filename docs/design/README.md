...
- [PushPull Idempotency](pushpull-idempotency.md): Filtering a retried pack whose changes were already stored, after a non-atomic PushPull left the client's checkpoint behind
