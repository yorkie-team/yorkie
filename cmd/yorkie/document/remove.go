...
var (
	flagForceRemoveIfAttached bool
)
...
func newRemoveCommand() *cobra.Command {
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return cli.RemoveDocument(ctx, projectName, documentKey, flagForceRemoveIfAttached)
		},
	}
}
...
func init() {
	...
	cmd.Flags().BoolVar(
		&flagForceRemoveIfAttached,
		"force",
		false,
		"force remove a document even if attached in clients",
	)
