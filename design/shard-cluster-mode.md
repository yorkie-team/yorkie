...
Also, this document will only explain about core concepts and implementation of shard cluster mode.

### Non-Goals

Addtional configuration on K8s/Istio environment will not be covered in this document.
