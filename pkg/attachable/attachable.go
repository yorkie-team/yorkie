...
// AttachableType represents the type of attachable resource.
type AttachableType string

const (
	// AttachableTypeDocument represents a document resource.
	AttachableTypeDocument AttachableType = "document"

	// AttachableTypePresence represents a presence resource.
	AttachableTypePresence AttachableType = "presence"
)
