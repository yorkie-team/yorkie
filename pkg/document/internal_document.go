...
// Traverse traverses the descendants of this document.
func (d *InternalDocument) Traverse(traverseFunc func(elem json.Element, parent json.Container) bool) {
	d.root.Object().Traverse(traverseFunc)
}
