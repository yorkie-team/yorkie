...
func TestSplayTree(t *testing.T) {
	...
	t.Run("max height splay test", func(t *testing.T) {
		...
		var testAnswer = []string{
			...
			"[1,1,1]A[2,1,2]B[3,1,3]C[4,1,4]D[5,1,5]E[6,1,6]F",
			"[1,1,1]A[2,1,2]B[3,1,3]C[4,1,4]D[5,1,5]E[6,1,6]F[7,1,7]G",
			"[1,1,1]A[2,1,2]B[3,1,3]C[4,1,4]D[5,1,5]E[6,1,6]F[7,1,7]G[8,1,8]H",
			"[1,1,1]A[2,1,2]B[3,1,3]C[4,1,4]D[5,1,5]E[6,1,6]F[7,1,7]G[8,1,8]H[9,1,9]I",
		}
